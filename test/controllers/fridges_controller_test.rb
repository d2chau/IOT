...
class FridgesControllerTest < ActionController::TestCase
  ...
  test "should create fridge" do
    assert_difference('Fridge.count') do
      post :create, fridge: { date_bought: @fridge.date_bought, item_id: @fridge.item_id, quantity: @fridge.quantity, user_id: @fridge.user_id }
    end
  ...
  test "should update fridge" do
    patch :update, id: @fridge, fridge: { date_bought: @fridge.date_bought, item_id: @fridge.item_id, quantity: @fridge.quantity, user_id: @fridge.user_id }
    assert_redirected_to fridge_path(assigns(:fridge))
  end
